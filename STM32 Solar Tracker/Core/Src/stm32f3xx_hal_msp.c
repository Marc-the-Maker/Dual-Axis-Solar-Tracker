...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN12
    */
    HAL_GPIO_DeInit(GPIOA, CURR_BAT_Pin|VOLT_PANEL_Pin|CURR_PANEL_Pin);

    HAL_GPIO_DeInit(VOLT_BAT_GPIO_Port, VOLT_BAT_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(VERT_ENC_A_GPIO_Port, VERT_ENC_A_Pin);

    HAL_GPIO_DeInit(VERT_ENC_B_GPIO_Port, VERT_ENC_B_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB4     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(AZI_ENC_A_GPIO_Port, AZI_ENC_A_Pin);

    HAL_GPIO_DeInit(AZI_ENC_B_GPIO_Port, AZI_ENC_B_Pin);
